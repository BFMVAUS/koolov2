...
- [Download](https://github.com/BFMVAUS/koolov2/releases) the latest Koolo release (recommended for most users), or alternatively you can [build it from source](#development-environment)
...
**Note:** This is only required if you want to build the project from source. If you want to run the bot, you can just download the [latest release](https://github.com/BFMVAUS/koolov2/releases).
...
```shell
git clone https://github.com/BFMVAUS/koolo-v2.git
cd koolo
build.bat
```
